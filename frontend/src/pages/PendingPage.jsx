  ...
  return (
    <div className={layoutClasses.container}>
      ...
      <div className={layoutClasses.addBox} onClick={() => setShowModel(true)}>
        <div className='flex items-center justify-center gap-3 text-gray-500 group-hover:text-purple-600 trasition-colors'>
          <div className='w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:shadow-mdmtrasition-all duration-200'>
      ...
      onClose={() => {setShowModel(false);setSelectTask(null);refreshTasks();}}
